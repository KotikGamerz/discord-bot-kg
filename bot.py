...
HNYC2_SCHEDULE = {
    ...
    "13:00": "🇳🇿 Новая Зеландия, 🇫🇯 Фиджи, 🇹🇻 Тувалу, 🇲🇭 Маршалловы Острова (UTC+12)",
    ...
    "20:00": "🇮🇳 Индия, 🇱🇰 Шри-Ланка (UTC+5)",
    "21:00": "🇦🇪 ОАЭ, 🇴🇲 Оман (UTC+4)",
    "22:00": "🇷🇺 Россия, 🇧🇾 Беларусь, 🇹🇷 Турция (UTC+3)",
    "23:00": "🇲🇩 Молдова, 🇷🇴 Румыния, 🇺🇦 Украина, 🇬🇷 Греция (UTC+2)",
    "00:00": "🇩🇪 Германия, 🇫🇷 Франция, 🇪🇸 Испания, 🇮🇹 Италия (UTC+1)",
    "01:00": "🇬🇧 Великобритания, 🇵🇹 Португалия (UTC+0)",
    "02:00": "🇨🇻 Кабо-Верде (UTC-1)",
    "03:00": "🇧🇷 Бразилия, 🇦🇷 Аргентина, 🇺🇾 Уругвай (UTC-3)",
    "04:00": "🇨🇱 Чили, 🇧🇴 Боливия (UTC-4)",
    "05:00": "🇺🇸 США (восток), 🇨🇦 Канада (UTC-5)",
    "06:00": "🇺🇸 США (центр), 🇨🇦 Канада (UTC-6)",
    "07:00": "🇺🇸 США (гора), 🇨🇦 Канада (UTC-7)",
    "08:00": "🇺🇸 США (тихоокеанское), 🇨🇦 Канада (UTC-8)",
    "09:00": "🇺🇸 Аляска (UTC-9)",
    "10:00": "🇵🇫 Французская Полинезия, 🇺🇸 Гавайи (UTC-10)",
    "11:00": "🇦🇸 Американское Самоа (UTC-11)"
}


def _hnyc2_hour_label(dt: datetime.datetime) -> str:
...
async def hnyc2_loop():
    ...
    # ⛔️ КЛЮЧ: если этот час уже отправляли — ВЫХОД
